...
const forecastEndpoit = `http://api.weatherapi.com/v1/forecast.json?key=${APP_KEY}&q=${city}&days=${days}&aqi=no&alerts=no`;
const locationsEndpoint = `http://api.weatherapi.com/v1/search.json?key=${APP_KEY}&q=${city}`;
